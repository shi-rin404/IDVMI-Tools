...
classes = (ui.IDVMI_Neox_tools, ui.IDVMI_3DM_tools, extract_frame_dump.IDVMI_OT_extract_frame_dump, set_textures.IDVMI_OT_set_textures, Export3DMigoto, IDVMI_OT_Import_Neox_Mesh, IDVMI_OT_Export_Neox_Mesh, IDVMI_OT_Export_Neox_Mod)